...
public class News_List_Adapter extends ArrayAdapter<News_List_Model> {

	Context context;

	public News_List_Adapter(Context context, int resource,
			List<News_List_Model> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		News_List_Model model = getItem(position);
		...
		viewHolder.news_list_item_text.setText(Html.fromHtml(model
				.getNews_list_title_sub()));

		viewHolder.news_list_item_date.setText("Publish date :"+Html.fromHtml(model
				.getNews_list_publish_date()));

		try {

			String image_url = model.getNews_list_image_url();
